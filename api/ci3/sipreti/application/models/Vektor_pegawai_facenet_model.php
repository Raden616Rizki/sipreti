...
class Vektor_pegawai_facenet_model extends CI_Model
{

	public $table = 'vektor_pegawai_facenet';
	...
	{
		$this->db->select('vektor_pegawai_facenet.*, pegawai.nama');
		$this->db->from($this->table);
		$this->db->join('pegawai', 'vektor_pegawai_facenet.id_pegawai = pegawai.id_pegawai', 'left');

		if (!empty($q)) {
			$this->db->like('vektor_pegawai_facenet.id_pegawai', $q);
			$this->db->or_like('pegawai.nama', $q);
		}

		if ($onlyActive) {
			$this->db->where('(vektor_pegawai_facenet.deleted_at IS NULL OR vektor_pegawai_facenet.deleted_at = "")');
		}
	...
	public function get_by_id_pegawai($id_pegawai)
	{
		...
		$this->db->where('(deleted_at IS NULL OR deleted_at = "")');
		return $this->db->get('vektor_pegawai_facenet')->result();
	}
...
/* End of file Vektor_pegawai_facenet_model.php */
/* Location: ./application/models/Vektor_pegawai_facenet_model.php */
