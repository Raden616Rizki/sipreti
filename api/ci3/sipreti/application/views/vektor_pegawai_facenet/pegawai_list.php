...
<body>
	...
	<div class="content-container">
		...
		<div class="toolbar">
			<form action="<?php echo site_url('vektor_pegawai_facenet/list_pegawai'); ?>" method="get" class="search-form">
				<input type="text" name="q" class="search-input" placeholder="Masukkan nama pegawai..."
					value="<?php echo $q; ?>">
				<button type="submit" class="search-btn">Cari</button>
				<?php if ($q <> ''): ?>
					<a href="<?php echo site_url('vektor_pegawai_facenet/list_pegawai'); ?>" class="reset-btn">Reset</a>
				<?php endif; ?>
			</form>
			<!-- <div>
				<form method="get" action="<?php echo site_url('vektor_pegawai_facenet/export_csv'); ?>"
