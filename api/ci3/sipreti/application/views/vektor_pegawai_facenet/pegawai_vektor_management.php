	...
	<div class="card-container">
		<div class="card">
						...
						<?php if (!empty($biometrik[$i])): ?>
							<div class="image-wrapper">
								...
								$foto_path = !empty($biometrik[$i]->url_foto)
									? base_url('uploads/vektor_pegawai_facenet/' . $biometrik[$i]->id_pegawai . '/' . $biometrik[$i]->url_foto)
								...
								<button class="delete-btn"
									onclick="openModal('<?= site_url('vektor_pegawai_facenet/delete_from_pegawai/' . $biometrik[$i]->id_pegawai . '/' . $biometrik[$i]->id_vektor_pegawai); ?>')">
			...
			<div class="form-actions">
				<a href="<?php echo site_url('vektor_pegawai_facenet/list_pegawai') ?>" class="btn-back">Kembali</a>
			</div>
		</div>
	</div>
	<footer class="footer">
