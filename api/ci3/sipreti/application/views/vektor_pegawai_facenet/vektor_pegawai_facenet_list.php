...
<head>
	...
	<title>Daftar Vektor Pegawai Facenet</title>
...
<body>
	...
	<div class="content-container">
		<div class="section-header">
			<h2 class="section-title">Daftar Vektor Pegawai Facenet</h2>
		</div>

		<div class="toolbar">
			<form action="<?php echo site_url('vektor_pegawai_facenet/index'); ?>" method="get" class="search-form">
				<input type="text" name="q" class="search-input" placeholder="Cari Nama Pegawai..."
					value="<?php echo $q; ?>">
				<button type="submit" class="search-btn">Cari</button>
				<?php if ($q <> ''): ?>
					<a href="<?php echo site_url('vektor_pegawai_facenet'); ?>" class="reset-btn">Reset</a>
				<?php endif; ?>
			</form>
			<div>
				...
				<a href="<?php echo site_url('vektor_pegawai_facenet/list_pegawai'); ?>" class="add-btn">Kelola Biometrik</a>
			</div>
		</div>
		...
		<table class="data-table">
			...
			<tbody>
				<?php foreach ($vektor_pegawai_facenet_data as $vektor_pegawai): ?>
					<tr>
						...
						<td>
							...
							$foto_path = !empty($vektor_pegawai->url_foto)
								? base_url('uploads/vektor_pegawai_facenet/' . $vektor_pegawai->id_pegawai . '/' . $vektor_pegawai->url_foto)
						...
						<td class="action-buttons">
							<a href="javascript:void(0);"
								onclick="openModal('<?php echo site_url('vektor_pegawai_facenet/delete/' . $vektor_pegawai->id_vektor_pegawai); ?>')"
