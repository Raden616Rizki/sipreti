...
<head>
	...
	<title>Daftar Vektor Pegawai Ghostfacenet</title>
...
<body>
	<div class="navbar">
		...
		<div class="navbar-right">
			...
			<a class="active" href="/sipreti/vektor_pegawai_ghostfacenet/list_pegawai">Biometrik Pegawai</a>
		</div>
	</div>

	<div class="content-container">
		<div class="section-header">
			<h2 class="section-title">Daftar Vektor Pegawai Ghostfacenet</h2>
		</div>

		<div class="toolbar">
			<form action="<?php echo site_url('vektor_pegawai_ghostfacenet/index'); ?>" method="get" class="search-form">
				<input type="text" name="q" class="search-input" placeholder="Cari Nama Pegawai..."
					value="<?php echo $q; ?>">
				<button type="submit" class="search-btn">Cari</button>
				<?php if ($q <> ''): ?>
					<a href="<?php echo site_url('vektor_pegawai_ghostfacenet'); ?>" class="reset-btn">Reset</a>
				<?php endif; ?>
			</form>
			<div>
				...
				<a href="<?php echo site_url('vektor_pegawai_ghostfacenet/list_pegawai'); ?>" class="add-btn">Kelola Biometrik</a>
			</div>
		</div>
		...
		<table class="data-table">
			...
			<tbody>
				<?php foreach ($vektor_pegawai_ghostfacenet_data as $vektor_pegawai): ?>
					<tr>
						...
						<td>
							...
							$foto_path = !empty($vektor_pegawai->url_foto)
								? base_url('uploads/vektor_pegawai_ghostfacenet/' . $vektor_pegawai->id_pegawai . '/' . $vektor_pegawai->url_foto)
						...
						<td class="action-buttons">
							<a href="javascript:void(0);"
								onclick="openModal('<?php echo site_url('vektor_pegawai_ghostfacenet/delete/' . $vektor_pegawai->id_vektor_pegawai); ?>')"
...
<script>
	...
	function showAccuracy() {
		...
		fetch('http://127.0.0.1:8000/attendance/evaluate-face-recognition-ghostfacenet/')
			.then(response => response.json())
			.then(data => {
