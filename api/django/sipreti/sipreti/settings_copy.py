"""
Django settings for sipreti project.
...
CI3_API_URL_GHOSTFACENET = "http://127.0.0.1/sipreti/vektor_pegawai_ghostfacenet/create_api"
...
WSGI_APPLICATION = 'sipreti.wsgi.application'
